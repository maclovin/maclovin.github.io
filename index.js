...
var _commands = {
  ...
  theme: function() {
    submitOutput('\nChanging theme...\n');
    var themes = ['default', 'hacker', 'nerd'];
    CurrentTheme = CurrentTheme === 2 ? 0 : CurrentTheme + 1;
...
document.onload = InputComponent.focus();